					...
					<div className="flex items-center mb-3 sm:mb-0">
						...
						<div className="ml-4">
							...
							<p className="text-xs text-gray-500">
								{role} &middot; {timestamp}
							</p>
						</div>
					</div>
					{category && <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium self-start sm:self-center ${categoryColorClasses[categoryColor] || "bg-gray-100 text-gray-800"}`}>{category}</span>}
				</div>
