...
const ChatListItem = ({ chat, isSelected, onSelect }) => (
  <button
    ...
    className={`w-full text-left p-3 flex items-start gap-3 border-b border-gray-100 transition-colors ${
  ...
  >
    ...
    <div className="flex-grow min-w-0">
      ...
      <div className="flex justify-between items-center mt-1">
        ...
        {chat.unread > 0 && (
          <span className="bg-indigo-600 text-white text-xs font-bold w-5 h-5 flex items-center justify-center rounded-full flex-shrink-0">
            {chat.unread}
          </span>
        )}
      </div>
