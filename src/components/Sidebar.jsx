...
const CheckSquare = () => <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 11 3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>;
const Bell = () => <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/></svg>;
const MessageSquare = () => <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>;
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      ...
      <nav className="flex-1 px-2 py-4 space-y-1">
        <NavItem to="/dashboard" icon={<LayoutDashboard />} isExpanded={isDesktopExpanded}>Dashboard</NavItem>
        <NavItem to="/screening" icon={<Search />} isExpanded={isDesktopExpanded}>Screening</NavItem>
        <NavItem to="/" icon={<Users />} isExpanded={isDesktopExpanded}>Stakeholders</NavItem>
        <NavItem to="/engagements" icon={<Briefcase />} isExpanded={isDesktopExpanded}>Engagements</NavItem>
        <NavItem to="/tasks" icon={<CheckSquare />} isExpanded={isDesktopExpanded}>Task Manager</NavItem>
        <NavItem to="/notifications" icon={<Bell />} isExpanded={isDesktopExpanded}>Notifications</NavItem>
        <NavItem to="/announcements" icon={<Megaphone />} isExpanded={isDesktopExpanded}>Announcements</NavItem>
        <NavItem to="/chats" icon={<MessageSquare />} isExpanded={isDesktopExpanded}>Chats</NavItem>
        <NavItem to="/settings" icon={<SettingsIcon />} isExpanded={isDesktopExpanded}>Settings</NavItem>
      </nav>
